...
const Register = () => {
  ...
  // const illustration = skin === 'dark' ? 'large.png' : 'large.png',
  ...
  return (
    <div className='auth-wrapper auth-cover'>
      <Row className='auth-inner m-0'>
        ...
        {/* <Col className='d-flex flex-column justify-content-center align-items-center auth-bg px-2 p-lg-5'  sm='12'>
          <h2>Sign Up Now. Find a Theory Test in 1 week.</h2>
          <h5>Our bots refresh the Government website every 2 minutes.</h5>
          <div>
            <button>FIND THEORY TESTS</button><span>press Enter</span>
          </div>
          <p>Takes 3 minutes</p>
        </Col> */}
      </Row>
